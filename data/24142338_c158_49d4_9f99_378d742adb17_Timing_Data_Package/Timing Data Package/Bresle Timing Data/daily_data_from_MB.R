...
Data <- read_csv(paste0(filepath,"Smolt_Bresle_Eu.csv"))
...
# 2002 no counts were taken so R detected this column as logical, convert to dble
Data$`2002` <- as.numeric(Data$`2002`)
...
Data <- gather(Data,year,count,`1996`:`2021`)
...
# export to csv
write_csv(Daily_Counts,"Smolt_Bresle_Eu_processed.csv")
write_csv(Quartiles,"Smolt_Bresle_Eu_Timing_Quartiles.csv")
